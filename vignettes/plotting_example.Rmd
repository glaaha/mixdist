...
# Plotting example: Combined plot (Fritz SI AJS)
This shows how to produce combined frequency plots containing empirical and theoretical distributions
...
The data objects ´xa´ and ´xb´ are available from the package anyway...
